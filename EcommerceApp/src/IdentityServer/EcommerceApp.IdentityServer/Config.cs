    ...
    public static class Config
    {
        ...
        public static IEnumerable<Client> Clients => new Client[]
        {
            ...
            new Client()
            {
                ...
                ClientSecrets = {new Secret("ecommerceSecret".Sha256())},
                AllowedScopes = { "discount_fullpermission", "ocelot_fullpermission",  "comment_fullpermission", "payment_fullpermission","order_fullpermission", "images_fullpermission","basket_fullpermission","catalog_fullpermission", "message_fullpermission","cargo_fullpermission",
            ...
            new Client()
            {
                ...
                AllowedGrantTypes = GrantTypes.ResourceOwnerPassword,
                ClientSecrets = {new Secret("ecommerceSecret".Sha256())},
                AllowedScopes = { "catalog_fullpermission", "discount_fullpermission","order_fullpermission","cargo_fullpermission","basket_fullpermission","ocelot_fullpermission","comment_fullpermission", "cargo_fullpermission","payment_fullpermission","images_fullpermission", "message_fullpermission",
                IdentityServerConstants.LocalApi.ScopeName,
                IdentityServerConstants.StandardScopes.Email,
                IdentityServerConstants.StandardScopes.Profile,
                IdentityServerConstants.StandardScopes.OpenId,},
